        ...
        return new Promise((resolve) => {
            ...
            this.secondTimeline
                ...
                .to(
                    ...
                    {
                        // check this position with other position
                        y: 6.5,
                    },
                    "same"
                )
                ...
                .to(
                    this.roomChildren.artone.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
                ...
                .to(
                    this.roomChildren.arttwo.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
                ...
                .to(
                    this.roomChildren.artthree.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
                ...
                .to(
                    this.roomChildren.truckshelf.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
